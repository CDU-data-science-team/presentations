...
* In particular this book https://engineering-shiny.org/
* And this book https://mastering-shiny.org/ 
...
[`r icons::fontawesome("twitter")` @DataScienceNott](https://twitter.com/ChrisBeeley)<br/>
